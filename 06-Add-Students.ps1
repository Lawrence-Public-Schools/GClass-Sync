...
$TLOG = ((".\Logs\" + (Get-Date -Format u) +"-Roster.log").Replace(" ", "-")).Replace(":", "-")
...
Function invite_class_student()
{
    ...
    PROCESS
    {
        ...
        {
            $GCR_Locals += $GCR_Participants | Select-Object -ExpandProperty Profile | Where-Object EmailAddress -Like $Domain_Filter
